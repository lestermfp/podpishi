...
auth = {
    ...
    usePopup: function(){
        ...
        smartAjax('/ajax/ajax_auth.php?context=authUser', {
            ...
            auth.btnSetText('РЈСЃРїРµС€РЅРѕ РІРѕС€Р»Рё');

        }, function(msg){

            auth.btnSetText('Р’РѕР№С‚Рё');
    ...
    restorePassword: function(){
        ...
        smartAjax('/ajax/ajax_auth.php?context=restorePassword' , {
            ...
            mainSite.postError('РќРѕРІС‹Р№ РїР°СЂРѕР»СЊ РѕС‚РїСЂР°РІР»РµРЅ РЅР° РІР°С€ E-mail','Р“РѕС‚РѕРІРѕ!');
    ...
    changePassword: function(){
        ...
        smartAjax('/ajax/ajax_auth.php?context=' + data.context, data, function(msg){
            ...
            mainSite.postError('РЎРѕС…СЂР°РЅРµРЅРѕ СѓСЃРїРµС€РЅРѕ.', 'Р“РѕС‚РѕРІРѕ!');


        }, function(msg){

            mainSite.postError(msg.error_text, 'РћС€РёР±РєР°!');
    ...
    onFileUploaded: function(_this){
        ...
        if (fileUploader.file_callback == 'avatarUpaloder.onUploadAvatar'){
            ...
            try {
                ...
                //mainSite.swal('Р¤РѕС‚РѕРіСЂР°С„РёСЏ СѓСЃРїРµС€РЅРѕ Р·Р°РіСЂСѓР¶РµРЅР°');
                return;
            }
...
/*
	РЎРїРµС†РёР°Р»СЊРЅР°СЏ РЅР°РґСЃС‚СЂРѕР№РєР° РґР»СЏ РєР»Р°СЃСЃР° fileUploader
*/
...
fileUploader.onExternalSuccess = function(data){
    ...
    /*
        Р“СЂСѓР·РёРј Р»РёСЃС‚ РІ РїР°РЅРµР»СЊ
    */
...
/*
  Р¤СѓРЅРєС†РёСЏ РІРѕР·РІСЂР°С‰Р°РµС‚ РѕРєРѕРЅС‡Р°РЅРёРµ РґР»СЏ РјРЅРѕР¶РµСЃС‚РІРµРЅРЅРѕРіРѕ С‡РёСЃР»Р° СЃР»РѕРІР° РЅР° РѕСЃРЅРѕРІР°РЅРёРё С‡РёСЃР»Р°  Рё РјР°СЃСЃРёРІР° РѕРєРѕРЅС‡Р°РЅРёР№
  @param  $number Integer Р§РёСЃР»Рѕ РЅР° РѕСЃРЅРѕРІРµ РєРѕС‚РѕСЂРѕРіРѕ РЅСѓР¶РЅРѕ СЃС„РѕСЂРјРёСЂРѕРІР°С‚СЊ РѕРєРѕРЅС‡Р°РЅРёРµ
  @param  $endingsArray  Array РњР°СЃСЃРёРІ СЃР»РѕРІ РёР»Рё РѕРєРѕРЅС‡Р°РЅРёР№ РґР»СЏ С‡РёСЃРµР» (1, 4, 5),
         РЅР°РїСЂРёРјРµСЂ array('СЏР±Р»РѕРєРѕ', 'СЏР±Р»РѕРєР°', 'СЏР±Р»РѕРє')
  @return String
*/
