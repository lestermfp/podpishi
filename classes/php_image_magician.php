...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/   
  ...
  { 
    ...
    if (!file_exists($this->fileName)) { if ($this->debug) { die('Image not found.'); }else{
      //return array();
...
## -------------------------------------------------------- 
    ...
    if (!file_exists($file) && !$this->checkStringStartsWith('http://', $file)) { if ($this->debug) {
      die('Image not found.'); }
      else{
      //die();
          throw new Exception('Image not found E');
...
## -------------------------------------------------------- 
  ...
  #       third party class to save as bmp.
    ...
    if (!is_writable($fileInfoArray['dirname'])) {  if ($this->debug) { die('The path is not writable. Please check your permissions.'.$fileInfoArray['dirname']); }else{ die(); }}
